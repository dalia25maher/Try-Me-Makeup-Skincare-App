...
class Loos extends StatelessWidget {
  const Loos ({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
             "Huda Beauty Loose Baking Powder – ultra-fine, long-lasting powder that sets makeup, blurs imperfections, and gives a flawless, airbrushed finish.",
